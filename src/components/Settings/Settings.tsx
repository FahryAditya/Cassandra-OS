...
export const Settings: React.FC<SettingsProps> = ({ isOpen, onClose }) => {
  ...
  const categories = [
    ...
    { id: 'battery', name: 'Battery & Power', icon: 'battery_charging_full' },
    { id: 'storage', name: 'Storage Manager', icon: 'hard_drive' },
    { id: 'permissions', name: 'App Permissions', icon: 'admin_panel_settings' },
    { id: 'privacy', name: 'Privacy Center', icon: 'verified_user' },
    { id: 'security', name: 'Security Center', icon: 'security' },
    { id: 'updates', name: 'Update Center', icon: 'system_update' },
    { id: 'backup', name: 'Backup & Restore', icon: 'backup' },
    { id: 'recovery', name: 'System Recovery', icon: 'medical_services' },
    { id: 'hardware', name: 'Hardware Information', icon: 'hardware' },
    { id: 'about', name: 'About CassandraOS', icon: 'info' },
    { id: 'error_center', name: 'Error Diagnostics', icon: 'bug_report' },
    { id: 'wifi', name: 'Wi-Fi Networks', icon: 'wifi' },
    { id: 'ethernet', name: 'Ethernet', icon: 'lan' },
    { id: 'vpn', name: 'VPN Tunnels', icon: 'vpn_key' },
    { id: 'netdetails', name: 'Network Details', icon: 'fingerprint' },
    { id: 'bluetooth', name: 'Bluetooth Devices', icon: 'bluetooth' },
    { id: 'printers', name: 'Printers & Scanners', icon: 'print' },
    { id: 'camera', name: 'Camera', icon: 'videocam' },
    { id: 'microphone', name: 'Microphone Input', icon: 'mic' },
    { id: 'audio', name: 'Audio Routing', icon: 'volume_up' },
    { id: 'notifications', name: 'Notifications', icon: 'notifications' },
    { id: 'dnd', name: 'Do Not Disturb', icon: 'do_not_disturb_on' },
    { id: 'accessibility', name: 'Accessibility', icon: 'accessibility_new' },
    { id: 'language', name: 'Language & Region', icon: 'language' },
    { id: 'datetime', name: 'Date & Time', icon: 'schedule' },
    { id: 'defaultapps', name: 'Default Applications', icon: 'apps' },
    { id: 'startupapps', name: 'Startup Applications', icon: 'launch' },
    { id: 'appstorage', name: 'App Storage', icon: 'storage' },
    { id: 'appdetails', name: 'Application Details', icon: 'info' },
    { id: 'sysdiagnostics', name: 'System Diagnostics', icon: 'verified' },
